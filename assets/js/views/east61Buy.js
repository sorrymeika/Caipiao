define('views/east61Buy',['zepto','ui/sl','util','app','views/loading'],function(require,exports,module) {
    var $=require('zepto'),
        sl=require('ui/sl'),
        app=require('app'),
        util=require('util'),
    ...
    module.exports=sl.Activity.extend({
        ...
        buy: function() {
            ...
            sl.prompt('请输入您的投注密码',function(res) {
                ...
                var east61BetData=localStorage.east61BetData.split('#'),
                    resultCode=[],
                    codes;

                $.each(east61BetData,function(i,code) {
                    codes=code.split('|');
        ...
        del: function(e) {
            var that=this,
                ...
                data=localStorage.east61BetData.split('#');

            data.splice($parent.index(),1);

            localStorage.east61BetData=data.join('#');
        ...
        onCreate: function() {
            ...
            if(!localStorage.east61BetData) {
                ...
                $.each(east61BetData,function(i,item) {
                    betData=item.split('|');

                    var itemData={
                        type: betData[1],
                        typeName: betData[1]=='01'?'单式':'复式'
                    },
                    ...
                    if(betData[1]=='01') {
                        ...
                        var blue=parseInt(betData[3].substr(start,2));
                        start+=2;
                        itemData.blue=betData[3].substr(start,blue*2);
                        itemData.num=num*blue;
                        itemData.red=codes;
                    }

define('views/f15c5Buy',['zepto','ui/sl','util','app','views/loading'],function (require,exports,module) {
    var $=require('zepto'),
        sl=require('ui/sl'),
        app=require('app'),
        util=require('util'),
    ...
    module.exports=sl.Activity.extend({
        ...
        buy: function () {
            ...
            sl.prompt('请输入您的投注密码',function (res) {
                ...
                var f15c5BetData=localStorage.f15c5BetData.split('#'),
                    resultCode=[],
                    codes;

                $.each(f15c5BetData,function(i,code) {
                    codes=code.split('|');
        ...
        del: function (e) {
            var that=this,
                ...
                data=localStorage.f15c5BetData.split('#');

            data.splice($parent.index(),1);

            localStorage.f15c5BetData=data.join('#');
        ...
        onCreate: function () {
            ...
            if(!localStorage.f15c5BetData) {
                ...
                $.each(f15c5BetData,function (i,item) {
                    betData=item.split('|');

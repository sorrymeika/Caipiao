define('views/qlc',['zepto','ui/sl','app','views/loading','util'],function (require,exports,module) {
    var $=require('zepto'),
        sl=require('ui/sl'),
        app=require('app'),
        util=require('util'),
    ...
    module.exports=sl.Activity.extend({
        ...
        buy: function () {
            ...
            if(localStorage.qlcBetData)
                localStorage.qlcBetData+='#'+betData;
            else
                localStorage.qlcBetData=betData;

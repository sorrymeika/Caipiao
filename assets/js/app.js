define('app',['util'],function (require,exports,module) {
    ...
    return {
        ...
        url: function (url) {
            return /^http\:\/\//.test(url)?url:navigator.platform=="Win32"||navigator.platform=="Win64"?'http://localhost:3922/assets/Index.cshtml?path='+encodeURIComponent(url):('http://ms1.962666.cn'+url);
        },
        post: function () {
